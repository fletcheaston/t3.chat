            ...
            <div
                ...
                className={cn(
                    ...
                    variant === "floating" || variant === "inset"
                        ...
                        : "border-silver-dull group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=right]:border-l",
                    className
                )}
                {...props}
            >
...
function SidebarGroupLabel({
    ...
    return (
        <Comp
            ...
            className={cn(
                "text-silver mb-2 flex shrink-0 items-center rounded-md text-center text-lg",
                className
            )}
            {...props}
        />
...
const sidebarMenuButtonVariants = cva(
    "peer/menu-button w-full overflow-hidden rounded-b-none rounded-t-lg px-0.5 py-0.5 text-left outline-hidden transition-[width,height,padding] disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50",
    {
        variants: {
            variant: {
                default:
                    "text-silver hover:bg-pantone-lighter hover:text-gunmetal-dark h-fit border-b-2 transition-all",
            },
            size: {
                default: "h-fit",
            },
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
    return (
        <ul
            ...
            className={cn(
                "border-silver-dull mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l px-2.5 py-0.5",
                "group-data-[collapsible=icon]:hidden",
                className
            )}
            {...props}
